  ...
  .patch(
    ...
    ({ params, body }) => updateResponsavel(params.id, body),
    {
      body: t.Object({
        ...
        numero: t.Optional(t.String()),
        complemento: t.Optional(t.String()),
        trabalhoCep: t.Optional(t.String()),
        trabalhoBairro: t.Optional(t.String()),
        trabalhoLogradouro: t.Optional(t.String()),
        trabalhoNumero: t.Optional(t.String()),
        trabalhoComplemento: t.Optional(t.String()),
        alternativoCep: t.Optional(t.String()),
        alternativoBairro: t.Optional(t.String()),
        alternativoLogradouro: t.Optional(t.String()),
        alternativoNumero: t.Optional(t.String()),
        alternativoComplemento: t.Optional(t.String()),
        nis: t.Optional(t.String()),
      }),
    }
  );
